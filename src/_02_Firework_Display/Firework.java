...
public class Firework{
	...
	public void launch() {
		...
		for(int i=0;i<firework.length;i++) {
			firework[i] = new Spark(FireworkDisplay.WIDTH/2, FireworkDisplay.HEIGHT);
		}
	...
	public void drawSparks(Graphics g) {
		for(int i=0;i<firework.length;i++) {
			Spark a = firework[i];
			g.setColor(a.color);
			g.fillOval(a.x, a.y, a.size, a.size);
		}
